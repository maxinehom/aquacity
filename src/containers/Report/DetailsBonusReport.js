...
import { Table, Select, Input, Space, DatePicker, Button, Row, Col, Pagination, Modal, Breadcrumb, PageHeader } from 'antd';
...
const DetailsBonus = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      key: 'operation',
      width: 100,
      render: () => <Button onClick={showModal} >
                      View
                    </Button>,
    },
  ];
  ...
  return (
    <div style={{width: '100%', padding:"40px 20px"}}>
      ...
      <Modal className="modalclass" title="Announcement Detail" visible={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
        <p>Some contents...</p>
        <p>Some contents...</p>
        <p>Some contents...</p>
      </Modal>
      {showFilter ? (<div>
        <ContentWrapper>
          <Row gutter={[40, 16]} justify="space-between">
           ...
           <ContentWrapper >
              <Table pagination={false} className='btnStyle' columns={columns} dataSource={data} />
