...
import { Row, Col, Tabs, Form, Input, Button, Select, Upload, message, Table, Card,Breadcrumb,PageHeader, Divider } from 'antd';
    ...
    <LayoutWrapper>
      ...
      <PageHeader
       ...
       >
          ...
          <Row gutter={[40, 16]} justify="space-between">
            ...
            <Col xs={24} sm={24} md={24} lg={24} xl={24} className="colstyle">
              <Row style={{ marginTop: '1%', marginRight: '0%', float: 'right' }}>
                ...
                <ContentWrapper>
                {showTable ? <Table className='btnStyle' columns={columns1} dataSource={data} /> : null}
                {showForm ? 
          ...
          <Row gutter={[40, 16]} justify="space-between">
            ...
            <Col xs={24} sm={24} md={24} lg={24} xl={24} className="colstyle">
              <Row style={{ marginTop: '1%', marginRight: '0%', float: 'right' }}>
                ...
                <ContentWrapper>
                {showTable ? <Table className='btnStyle' columns={columns2} dataSource={data} /> : null}
                {showForm ? 
                <Form
                form={form}
        ...
        <ContentWrapper>
                  {showTable ? <Table className='btnStyle' columns={columns3} dataSource={data} /> : null}
                  {showForm ?
                    <div>
                      <Form
                        form={form}
